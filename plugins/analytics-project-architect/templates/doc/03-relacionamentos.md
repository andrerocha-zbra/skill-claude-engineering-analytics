<!--
  TEMPLATE · doc Power BI · 03-relacionamentos.md
  Salvar como docs/03-relacionamentos.md na raiz do projeto Power BI
...
> **Tom:** descrever, não opinar. Auditoria de qualidade dos relacionamentos (anti-patterns, bi-direcional desnecessário, etc.) é um exercício separado, fora do escopo desta doc.
